...
public class VendaTest {
	...
	public void testComprarIngressoComSucesso() {
		...
		/* Clausulas catch para a exceção CompradorNaoEncontradoException foram adicionadas aos blocos
		 * try/catch que contém chamada ao método recuperarIngressos .
		 */
		...
		Iterador i = null;
		try {
			i = controllerComprador.recuperarIngressos(compradorTeste).iterador();
		} catch (CompradorNuloException e) {
			fail();
		} catch (CompradorNaoEncontradoException e) {
			fail();
