...
/**
 * Exceção lançada ao tentar cadastrar um cinema nulo.
 * 
...
public class CinemaNuloException extends Exception  {
	...
	public CinemaNuloException() {
		super("Impossível realizar a operação, pois o cinema informado é nulo.");
	}
	...
	public CinemaNuloException(Throwable causa) {
		super("Impossível realizar a operação, pois o cinema informado é nulo.", causa);
	}
