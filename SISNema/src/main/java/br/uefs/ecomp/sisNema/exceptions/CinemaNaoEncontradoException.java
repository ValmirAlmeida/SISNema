...
/**
 * Exceção lançada quando não for encontrado um cadastro de cinema.
 * 
...
public class CinemaNaoEncontradoException extends Exception  {
	...
	public CinemaNaoEncontradoException() {
		super("Não foi encontrado registro do cinema com o ID informado.");
	}
	...
	public CinemaNaoEncontradoException(Throwable causa) {
		super("Não foi encontrado registro do cinema com o ID informado.", causa);
	}
